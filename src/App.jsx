        ...
        <div className={`h-[100dvh] w-full transition-colors duration-300 ${isDark ? 'dark' : ''} overflow-hidden flex flex-col relative`} onDragOver={handleDragOver} onDragLeave={handleDragLeave} onDrop={handleDrop}>
            ...
            <div className="relative z-10 flex flex-1 h-full overflow-hidden">
                ...
                <div className="flex-1 flex flex-col h-full overflow-hidden relative">
                    ...
                    {/* --- MENU MOBILE FIXE --- */}
                    {/* MODIFICATION ICI : bg-white/90 dark:bg-black/90 + border-white/5 */}
                    {/* Ce style assure que le fond est NOIR (pas gris) et transparent flouté */}
                    <div className="fixed bottom-0 left-0 right-0 z-40 md:hidden bg-white/90 dark:bg-black/90 backdrop-blur-lg border-t border-gray-200 dark:border-white/5 pb-[env(safe-area-inset-bottom)] pt-1 shadow-lg">
