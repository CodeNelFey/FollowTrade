...
const TradeHistory = ({ trades, onDelete, onEdit, currencySymbol, colors }) => {
    ...
    return (
        <>
            ...
            {/* --- VUE MOBILE : CARDS --- */}
            {/* CORRECTION : RETRAIT DU pb-20 ICI (C'est App.jsx qui gère l'espace) */}
            ...
            {/* ... (Reste du fichier inchangé : Vue PC, Modales, Filtres...) */}
