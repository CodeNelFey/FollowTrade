...
import { X, Check, Sun, Moon, Zap, Briefcase, Target, Trophy, Clock, Calendar, BarChart2, Flag, Activity } from 'lucide-react';
...
const FREQUENCIES = [
    ...
    { id: 'YEARLY', label: 'Annuel (Reset 1er Janvier)' }, // AJOUT ICI
    { id: 'ONCE', label: 'Unique (Pas de Reset)' },
];

const TodoListModal = ({ isOpen, onClose, onCreate }) => {
    ...
    const handleSubmit = (e) => {
        ...
        onCreate({ title, icon: selectedIcon, color: selectedColor, frequency });
        setTitle('');
        onClose();
    };
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in">
            <div className="bg-white dark:bg-neutral-900 w-full max-w-md rounded-3xl shadow-2xl border border-white/20 dark:border-white/10 overflow-hidden">
                <div className="p-6 border-b border-gray-100 dark:border-neutral-800 flex justify-between items-center">
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white">Nouvelle Liste</h3>
